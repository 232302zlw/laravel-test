<?php /*a:1:{s:82:"D:\phpStudy\PHPTutorial\WWW\1901\myshop\application\index\view\member\address.html";i:1561018864;}*/ ?>
...
<div class="m_top_bg">
    <div class="top">
        <div class="m_logo"><a href="Index.html"><img src="/static/index/images/logo1.png" /></a></div>
        <div class="m_search">
            <form>
...
<div class="i_bg bg_color">
	...
	<div class="m_content">
		...
		<div class="address">
            	<div class="a_close"><a href="#"><img src="/static/index/images/a_close.png" /></a></div>
            	<table border="0" class="add_t" align="center" style="width:98%; margin:10px auto;" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td><?php echo htmlentities($v['consignee']); ?></td>
                  </tr>
                  <tr>
                    <td align="right">配送区域：</td>
                    <td><?php echo htmlentities($v['province']); ?> <?php echo htmlentities($v['city']); ?> <?php echo htmlentities($v['district']); ?></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><?php echo htmlentities($v['sign_building']); ?></td>
                  </tr>
                </table>
				
                <p align="right">
                    <?php if($v['is_default']!=1): ?>
                    <a href="javascript:void(0)" onclick="changeSelet(<?php echo htmlentities($v['address_id']); ?>)" style="color:#ff4e00;">设为默认</a>
                    <?php endif; ?>
            ...
            <script>
                function changeSelet(address_id){
                    if(!address_id){
                        alert('发生未知错误，请联系管理员');return;
                    }
                    
                    jQuery.post('<?php echo url("Member/changeSelet"); ?>',{address_id:address_id},function(data){
                        if(data){
            ...
            <form action="<?php echo url('Order/saveaddress',['goods_id'=>$goods_id]); ?>" method="post">
            ...
            <script>
                jQuery('select').change(function(){
                    ...
                    jQuery.post('<?php echo url("Order/getSonAddress"); ?>',{parent_id:parent_id},function(data){
                        if(data.code!='00000'){
                            alert(data.msg);
                            return;
                        }
