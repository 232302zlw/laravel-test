<?php /*a:5:{s:78:"D:\phpStudy\PHPTutorial\WWW\1901\myshop\application\index\view\cart\lists.html";i:1560928868;s:74:"D:\phpStudy\PHPTutorial\WWW\1901\myshop\application\index\view\layout.html";i:1560932880;s:81:"D:\phpStudy\PHPTutorial\WWW\1901\myshop\application\index\view\public\header.html";i:1560306274;s:82:"D:\phpStudy\PHPTutorial\WWW\1901\myshop\application\index\view\public\leftnav.html";i:1560484138;s:81:"D:\phpStudy\PHPTutorial\WWW\1901\myshop\application\index\view\public\footer.html";i:1559616188;}*/ ?>
...
<div class="i_bg">  
    ...
    <div class="content mar_20">
    	<table border="0" class="car_tab" style="width:1200px; margin-bottom:50px;" cellspacing="0" cellpadding="0">
          ...
          <tr <?php if($k%2==0): ?> class="car_tr" <?php endif; ?>>
              <td>
                  <input class="goodsbox" type="checkbox" <?php if((in_array($v['goods_id'],$goods_id))): ?> checked="checked" <?php endif; ?>value="<?php echo htmlentities($v['goods_id']); ?>" />
            </td>
            <td>
            ...
            <td align="center">
            	<div class="c_num">
                    <input type="button" value="" onclick="jianUpdate1(jq(this),<?php echo htmlentities($v['goods_id']); ?>);" class="car_btn_1" />
                	<input type="text" goods_id="<?php echo htmlentities($v['goods_id']); ?>" value="<?php echo htmlentities($v['buy_number']); ?>" name="" class="car_ipt" />  
                    <input type="button" value="" onclick="addUpdate1(jq(this),<?php echo htmlentities($v['goods_id']); ?>);" class="car_btn_2" />
                </div>
            </td>
            <td align="center" style="color:#ff4e00;">￥<font><?php echo htmlentities($v['goods_price']); ?></font></td>
            <td align="center"><a href="javascript:void(0)" class="del" goods_id="<?php echo htmlentities($v['goods_id']); ?>">删除</a>&nbsp; &nbsp;<a href="#">加入收藏</a></td>
          </tr>
          <?php endforeach; endif; else: echo "" ;endif; ?>
          <tr height="70">
          	<td colspan="6" style="font-family:'Microsoft YaHei'; border-bottom:0;">
            	<input type="button" class="del" value="删除">
                <span class="fr">商品总价：<b style="font-size:22px; color:#ff4e00;">￥<font class="total"><?php echo htmlentities($total); ?></font></b></span>
            </td>
          </tr>
          <tr valign="top" height="150">
          	<td colspan="6" align="right">
            	<a href="/"><img src="/static/index/images/buy1.gif" /></a>&nbsp; &nbsp; 
                <a href="javascript:void(0)" onclick="checkout()"><img src="/static/index/images/buy2.gif" /></a>
            </td>
          </tr>
        </table>
    ...
    <script>
       function checkout(){
           ...
           jQuery.post('<?php echo url("Cart/checkout"); ?>',function(data){
               if( data==false){
                   var url = window.location.href+"?goods_id="+goods_id;
                   location.href="<?php echo url('Login/login'); ?>?refer="+url;
               }else{
                   location.href="<?php echo url('Order/index'); ?>?goods_id="+goods_id;
               }
           });
     ...
     function getMoney(){
         ...
         if( goods_id ){
             jQuery.post('<?php echo url("Cart/getMoney"); ?>',{goods_id:goods_id},function(data){
     ...
     jQuery('.del').click(function(){
        ...
        if( confirm('确定删除吗？')){
            jQuery.post('<?php echo url("Cart/delete"); ?>',{goods_id:goods_id},function(data){
                     alert(data.msg); 
