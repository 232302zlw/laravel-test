<?php /*a:4:{s:86:"E:\phpStudy\PHPTutorial\WWW\month4\1901b\myshop\application\admin\view\goods\edit.html";i:1558688145;s:82:"E:\phpStudy\PHPTutorial\WWW\month4\1901b\myshop\application\admin\view\layout.html";i:1557798597;s:89:"E:\phpStudy\PHPTutorial\WWW\month4\1901b\myshop\application\admin\view\public\header.html";i:1558054745;s:87:"E:\phpStudy\PHPTutorial\WWW\month4\1901b\myshop\application\admin\view\public\left.html";i:1558323279;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<body class="layui-layout-body">
  <div class="layui-layout layui-layout-admin">
    ...
    <form id="myform" enctype='multipart/form-data'>
        <input type="hidden" name="goods_id" value="<?php echo htmlentities($goodsInfo['goods_id']); ?>">
        <div class="layui-form-item">
            <label class="layui-form-label">商品名称</label>
            <div class="layui-input-block">
                <input type="text" name="goods_name"  autocomplete="off" class="layui-input" value="<?php echo htmlentities($goodsInfo['goods_name']); ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">价格</label>
            <div class="layui-input-block">
                <input type="text" name="goods_price"  autocomplete="off" class="layui-input" value="<?php echo htmlentities($goodsInfo['goods_price']); ?>">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="goods_number"  autocomplete="off" class="layui-input" value="<?php echo htmlentities($goodsInfo['goods_number']); ?>">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <input type="hidden" name="goods_img" id="goods_img" value="<?php echo htmlentities($goodsInfo['goods_img']); ?>"><br>
                <img src="/upload/goods_img/<?php echo htmlentities($goodsInfo['goods_img']); ?>" alt="" width="50px;" height="50px;">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <input type="hidden" name="goods_imgs" id="goods_imgs" value="<?php echo htmlentities($goodsInfo['goods_imgs']); ?>"><br>
                <?php if(is_array($goodsInfo['g_imgs']) || $goodsInfo['g_imgs'] instanceof \think\Collection || $goodsInfo['g_imgs'] instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsInfo['g_imgs'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                <img src="/upload/goods_imgs/<?php echo htmlentities($v); ?>" alt="" width="50px;" height="50px;">
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea  name="goods_describe" class="layui-textarea"><?php echo htmlentities($goodsInfo['goods_describe']); ?></textarea>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="cate_id">
                    <?php if(is_array($cateInfo) || $cateInfo instanceof \think\Collection || $cateInfo instanceof \think\Paginator): $i = 0; $__LIST__ = $cateInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;if($goodsInfo['cate_id']==$v['cate_id']): ?>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="brand_id" >
                    <?php if(is_array($brandInfo) || $brandInfo instanceof \think\Collection || $brandInfo instanceof \think\Paginator): $i = 0; $__LIST__ = $brandInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;if($goodsInfo['brand_id']==$v['brand_id']): ?>
                    <option value="<?php echo htmlentities($v['brand_id']); ?>" selected><?php echo htmlentities($v['brand_name']); ?></option>
                    <?php else: ?>
